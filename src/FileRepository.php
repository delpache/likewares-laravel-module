...
use Likewares\Module\Exceptions\InvalidAssetPath;
use Likewares\Module\Exceptions\ModuleNotFoundException;
use Likewares\Module\Process\Installer;
use Likewares\Module\Process\Updater;

abstract class FileRepository implements IRepositoryInterface, Countable
{
    use Macroable;
     ...
     * @return string
     * @throws \Likewares\Module\Exceptions\ModuleNotFoundException
     */
